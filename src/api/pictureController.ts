...
/** listPictureVOByPageWithMultiLevelCache POST /api/picture/list/page/vo/multiLevelCache */
export async function listPictureVoByPageWithMultiLevelCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/vo/multiLevelCache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
